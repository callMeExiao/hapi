export default {
  ...
  'chat.event.switchedToLocal': 'Switched to local',
  'chat.event.switchedToRemote': 'Switched to remote',
  'chat.event.apiError.maxRetriesReached': 'API error: Max retries reached',
  'chat.event.apiError.retryingWithProgress': 'API error: Retrying ({retryAttempt}/{maxRetries})',
  'chat.event.apiError.retrying': 'API error: Retrying...',
  'chat.event.apiError.base': 'API error',
  'chat.event.titleChangedTo': 'Title changed to "{title}"',
  'chat.event.titleChanged': 'Title changed',
  'chat.event.permissionModeChanged': 'Permission mode: {mode}',
  'chat.event.limitReachedUntil': 'Usage limit reached until {time}',
  'chat.event.limitReached': 'Usage limit reached',
  'chat.event.messageFallback': 'Message',
  'chat.event.turnDuration': 'Turn: {duration}',
  'chat.event.duration.seconds': '{seconds}s',
  'chat.event.duration.minutesSeconds': '{minutes}m {seconds}s',
  'chat.event.microcompact': 'Context compacted (saved {tokens} tokens)',
  'chat.event.compact': 'Conversation compacted',
  'chat.permissionMode.default': 'Default',
  'chat.permissionMode.acceptEdits': 'Accept Edits',
  'chat.permissionMode.bypassPermissions': 'Yolo',
  'chat.permissionMode.plan': 'Plan Mode',
  'chat.permissionMode.ask': 'Ask Mode',
  'chat.permissionMode.readOnly': 'Read Only',
  'chat.permissionMode.safeYolo': 'Safe Yolo',
  'chat.permissionMode.yolo': 'Yolo',
