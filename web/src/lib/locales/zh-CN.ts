export default {
  ...
  'chat.event.switchedToLocal': '已切换到本地',
  'chat.event.switchedToRemote': '已切换到远程',
  'chat.event.apiError.maxRetriesReached': 'API 错误：已达到最大重试次数',
  'chat.event.apiError.retryingWithProgress': 'API 错误：正在重试（{retryAttempt}/{maxRetries}）',
  'chat.event.apiError.retrying': 'API 错误：正在重试…',
  'chat.event.apiError.base': 'API 错误',
  'chat.event.titleChangedTo': '标题已更改为“{title}”',
  'chat.event.titleChanged': '标题已更改',
  'chat.event.permissionModeChanged': '权限模式：{mode}',
  'chat.event.limitReachedUntil': '已达到使用额度上限，直到 {time}',
  'chat.event.limitReached': '已达到使用额度上限',
  'chat.event.messageFallback': '消息',
  'chat.event.turnDuration': '本轮耗时：{duration}',
  'chat.event.duration.seconds': '{seconds} 秒',
  'chat.event.duration.minutesSeconds': '{minutes} 分 {seconds} 秒',
  'chat.event.microcompact': '上下文已压缩（节省 {tokens} 个令牌）',
  'chat.event.compact': '对话已压缩',
  'chat.permissionMode.default': '默认',
  'chat.permissionMode.acceptEdits': '接受编辑',
  'chat.permissionMode.bypassPermissions': 'YOLO 模式',
  'chat.permissionMode.plan': '计划模式',
  'chat.permissionMode.ask': '询问模式',
  'chat.permissionMode.readOnly': '只读',
  'chat.permissionMode.safeYolo': '安全 YOLO',
  'chat.permissionMode.yolo': 'YOLO 模式',
